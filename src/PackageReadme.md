...
**This package (1.x) targets Optimizely CMS 12 on .NET 10.** For Optimizely CMS 13, use version 2.x.
...
```bash
dotnet add package Avantibit.Optimizely.CustomSettings --version 1.*
```
...
https://github.com/AvantiBit/custom-settings/tree/support/cms12
